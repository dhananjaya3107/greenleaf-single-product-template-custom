			...
			<?php while ( have_posts() ) : the_post(); ?>
				...
				<div class="row">
					...
					<?php 
						...
						// artificial plant start
						elseif(in_array( 'artificial-plants', $categories ) ){
					?>
						...
						<div class="col-xs-12 col-md-8 col-lg-8">
							...
							<div class="single-product-content">
								...
								<div class="single-add-to-cart-button">
									...
									<?php if ( in_array( 'artificial-plants', $categories ) ) { // artificial-plants category check if start ?>
									...
									<?php } //if artificial plant cat end ?>
						...
						<div class="col-xs-12 col-md-8 col-lg-8">
							...
							<div class="single-product-content">
								...
								<div class="single-add-to-cart-button">
									...
									<?php if ( in_array( 'artificial-plants', $categories ) ) { // artificial-plants category check if start ?>
										...
										<?php else : ?>
											...
											<?php
												...
												// If there is a artificial_plant product.
												if ( $product->product_type == 'artificial_plant' ) {
													?>
													...
													<?php //echo sprintf( '<button class="product-page-add-to-cart" productid="'.$product->id.'">Add to cart</button>' ); ?>
													
													<?php
												} else {
													//echo sprintf( '<button class="product-page-add-to-cart" productid="'.$product->id.'">Add to cart</button>' );
												  //echo apply_filters( 'woocommerce_loop_add_to_cart_link', sprintf('<a href="%s" rel="nofollow" data-product_id="%s" data-product_sku="%s" class="%s button product_type_%s">%s</a>', esc_url( $link['url'] ), esc_attr( $product->id ), esc_attr( $product->get_sku() ), esc_attr( $link['class'] ), esc_attr( $product->product_type ), esc_html( $link['label'] ) ), $product, $link );
												}
											?>
										<?php endif; ?>
										
									<?php } else { // artificial-plants category check if end else start ?>
									...
									<?php } // artificial-plants category check else end ?>
